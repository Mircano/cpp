...
void Essai1()
{
  ...
  {
	  cout << endl << "Erreure : " << e.getMsg() << endl;
  }
  catch (...)
  {
	  cout << endl << "Erreure inconnue" << endl;
  }
  // ... a remplacer
...
void Essai3()
{
  ...
  {
	  cout << endl << "Erreure : " << e.getMsg() << " Rouge Valide : " << e.rougeValide() << ", Vert Valide : " << e.vertValide() << ", Bleu Valide : " << e.bleuValide() << endl;
  }
  catch (...)
  {
	  cout << endl << "Erreure inconnue" << endl;
